...
public class FitnessProcessorTopology {
    ...
    private Topology createTopology() {
        ...
        StreamsBuilder builder = new FitnessFlowsBuilder()
          .setupDuplicateGeneratorFlow("fitness-data")
          .setupHashGeneratorFlow("fitness-data", "S_FITNESS_DATA_KEY_GEN")
          .setupDuplicateDetectorFlow("S_FITNESS_DATA_KEY_GEN", "DUPLICATE_KEYS")
          .getBuilder();
