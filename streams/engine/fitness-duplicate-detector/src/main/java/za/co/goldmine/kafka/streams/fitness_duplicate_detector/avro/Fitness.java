...
public class Fitness extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5860003183877595825L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Fitness\",\"namespace\":\"za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro\",\"doc\":\"Defines hypothetical Fitness Data\",\"fields\":[{\"name\":\"activityType\",\"type\":{\"type\":\"string\",\"arg.properties\":{\"options\":[\"Walking\",\"Running\",\"Cycling\",\"Swimming\"]}},\"doc\":\"Summary of data\"},{\"name\":\"startTimeInSeconds\",\"type\":{\"type\":\"long\",\"arg.properties\":{\"range\":{\"min\":1487715775521,\"max\":1519273364600}}}},{\"name\":\"averageHeartRateInBeatsPerMinute\",\"type\":{\"type\":\"double\",\"arg.properties\":{\"range\":{\"min\":50,\"max\":200}}}},{\"name\":\"activeKilocalories\",\"type\":{\"type\":\"int\",\"arg.properties\":{\"range\":{\"min\":1,\"max\":200}}}},{\"name\":\"distanceInMeters\",\"type\":{\"type\":\"double\",\"arg.properties\":{\"range\":{\"min\":1,\"max\":10000}}},\"doc\":\"A simulated distance\"},{\"name\":\"durationInSeconds\",\"type\":{\"type\":\"int\",\"arg.properties\":{\"range\":{\"min\":1,\"max\":10000}}},\"doc\":\"Simulated Time\"},{\"name\":\"steps\",\"type\":{\"type\":\"int\",\"arg.properties\":{\"range\":{\"min\":5,\"max\":20000}}},\"doc\":\"A simulated number of steps\"},{\"name\":\"floorsClimbed\",\"type\":{\"type\":\"int\",\"arg.properties\":{\"range\":{\"min\":1,\"max\":20}}},\"doc\":\"Simulated number of floors climbed\"},{\"name\":\"manufacturerName\",\"type\":{\"type\":\"string\",\"arg.properties\":{\"options\":[\"Garmin\",\"Fitbit\",\"Samsung\",\"Polar\",\"Apple\"]}},\"doc\":\"Name of upload device\"},{\"name\":\"userid\",\"type\":{\"type\":\"string\",\"arg.properties\":{\"regex\":\"User_[1-9]{0,1}\"}},\"doc\":\"The simulated user who sent the fitness data\"},{\"name\":\"tenant_id\",\"type\":{\"type\":\"int\",\"arg.properties\":{\"range\":{\"min\":1,\"max\":20}}},\"doc\":\"The simulated tenant id\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<Fitness> ENCODER =
      new BinaryMessageEncoder<Fitness>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<Fitness> DECODER =
      new BinaryMessageDecoder<Fitness>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<Fitness> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Fitness> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Fitness> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Fitness>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this Fitness to a ByteBuffer.
  ...
  /**
   * Deserializes a Fitness from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a Fitness instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static Fitness fromByteBuffer(
  ...
  /**
   * Creates a new Fitness RecordBuilder.
   * @return A new Fitness RecordBuilder
   */
  public static za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder newBuilder() {
    return new za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder();
  }

  /**
   * Creates a new Fitness RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new Fitness RecordBuilder
   */
  public static za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder newBuilder(za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder other) {
    if (other == null) {
      return new za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder();
    } else {
      return new za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder(other);
    }
  }

  /**
   * Creates a new Fitness RecordBuilder by copying an existing Fitness instance.
   * @param other The existing instance to copy.
   * @return A new Fitness RecordBuilder
   */
  public static za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder newBuilder(za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness other) {
    if (other == null) {
      return new za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder();
    } else {
      return new za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder(other);
  ...
  /**
   * RecordBuilder for Fitness instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Fitness>
    implements org.apache.avro.data.RecordBuilder<Fitness> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing Fitness instance
     * @param other The existing instance to copy.
     */
    private Builder(za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.activityType)) {
        this.activityType = data().deepCopy(fields()[0].schema(), other.activityType);
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setActivityType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearActivityType() {
      activityType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setStartTimeInSeconds(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearStartTimeInSeconds() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setAverageHeartRateInBeatsPerMinute(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearAverageHeartRateInBeatsPerMinute() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setActiveKilocalories(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearActiveKilocalories() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setDistanceInMeters(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearDistanceInMeters() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setDurationInSeconds(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearDurationInSeconds() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setSteps(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearSteps() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setFloorsClimbed(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearFloorsClimbed() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setManufacturerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearManufacturerName() {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setUserid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearUserid() {
      userid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder setTenantId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public za.co.goldmine.kafka.streams.fitness_duplicate_detector.avro.Fitness.Builder clearTenantId() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<Fitness>
    WRITER$ = (org.apache.avro.io.DatumWriter<Fitness>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Fitness>
    READER$ = (org.apache.avro.io.DatumReader<Fitness>)MODEL$.createDatumReader(SCHEMA$);
